      ...
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <div class="flex justify-center mb-4">
            <div class="w-16 h-16 bg-primary-500 rounded-box flex items-center justify-center shadow-strong">
        ...
        <div class="bg-white rounded-box shadow-strong p-8 border-2 border-gray-100">
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full py-3 rounded-field text-base font-bold bg-primary-500 text-white hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed shadow-medium transition-all"
            >
          ...
          <div class="mt-8 pt-6 border-t-2 border-gray-100 space-y-3">
            <p class="text-center text-sm text-gray-600">
              ...
              <NuxtLink to="/register" class="font-bold text-primary-600 hover:text-primary-700">
                Create Account
              </NuxtLink>
            </p>
            <p class="text-center text-xs text-gray-500">
              Need to create the first admin?
              <NuxtLink to="/init-admin" class="font-semibold text-secondary-600 hover:text-secondary-700">
                Initialize Admin
              </NuxtLink>
            </p>
          </div>
